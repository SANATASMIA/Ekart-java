...
```
cd existing_repo
git remote add origin https://gitlab.com/devops2272119/ekart-java.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/devops2272119/ekart-java/-/settings/integrations)
...
>>>>>>> c4b1635 (moving local to remote)
